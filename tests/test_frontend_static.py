...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_beta_delivery_readiness_is_wired(self):
        ...
        self.assertIn("function scheduledTaskDate(task)", JS)
        self.assertIn('if(task.type !== "capacity" || !isDeliveryTask(task)) return false;', JS)
        self.assertIn("scheduledTaskDate(task)", JS)
